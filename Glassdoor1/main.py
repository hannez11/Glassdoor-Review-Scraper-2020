...
formatter = logging.Formatter(
    ...
    'PROCESS1 %(asctime)s - %(message)s', "%H:%M:%S")
...
def get_browser():
    ...
    browser = wd.Chrome('F://Coding//Projects//Glassdoor//Glassdoor1//chromedriver.exe', options=chrome_options) #change for each process
    return browser
